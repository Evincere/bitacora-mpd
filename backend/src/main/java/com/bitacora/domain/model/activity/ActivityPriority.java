...
/**
 * Enumeración que representa los diferentes niveles de prioridad para las actividades.
 */
public enum ActivityPriority {
    ...
    ActivityPriority(int value, String displayName) {
        this.value = value;
     ...
     */
    public static ActivityPriority fromValue(int value) {
        for (ActivityPriority priority : ActivityPriority.values()) {
    ...
    /**
     * Convierte un string en un ActivityPriority, ignorando mayúsculas/minúsculas y acentos.
     ...
     */
    public static ActivityPriority fromString(String text) {
