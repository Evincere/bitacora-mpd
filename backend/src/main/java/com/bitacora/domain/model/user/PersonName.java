 ...
 */
public final class PersonName extends AbstractValueObject {
     ...
     */
    private PersonName(final String firstName, final String lastName) {
     ...
     */
    public static PersonName of(final String firstName, final String lastName) {
