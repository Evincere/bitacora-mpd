...
public class WebSocketController {
    ...
    public void handleNotification(
            @Payload RealTimeNotification notification,
    ...
    public void handleUserStatus(
            @Payload UserStatusEvent statusEvent,
            SimpMessageHeaderAccessor headerAccessor,
            Authentication authentication) {
        ...
        if (statusEvent.getUserId() != null) {
            // Aquí deberías verificar que el ID del usuario coincida con el usuario autenticado
    ...
    public void handleSessionActivity(
            @Payload SessionActivityEvent activityEvent,
            SimpMessageHeaderAccessor headerAccessor,
            Authentication authentication) {
    ...
    public void handleSystemAlert(
            @Payload SystemAlertEvent alertEvent,
            SimpMessageHeaderAccessor headerAccessor,
            Authentication authentication) {
